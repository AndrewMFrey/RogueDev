...
def render_all(con, panel, entities, player, game_map, fov_recompute, root_console, message_log, screen_width,
    ...
    if fov_recompute:
        ...
        for x, y in game_map:
            ...
            # If player is in field of view, render and mark as explored.
            if game_map.fov[x, y]:
                if wall:
            ...
            # If player is not in field of view, but area has been explored.
    ...
    # Print the game messages liny by line
    y = 1
